/**
 * Contract types from spec v0.1 §6.1 and v0.2 §6.2.
 *
 * Duplicated from `packages/core/src/types.ts` to keep this package free of a
 * core dependency — the workspace's structural-assignability check in
 * `packages/core/src/stores/redis.ts` guarantees the shapes stay in lockstep.
 */
